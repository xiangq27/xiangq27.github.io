...
public class UDPServer {
    ...
    public static void main(String[] args) throws Exception {
		...
		//InetAddress sIP2 = InetAddress.getByName("172.27.5.145");
		//DatagramSocket serverSocket2 = new DatagramSocket(serverPort, sIP2); 
		...
		while (true){
	    	...
	    	/*
			parse receivedPacket -> dnsMsg
			if (reply) {
				// send to the client who sent the query
				locate the client ip/port from the transction id
			} else {
				check if cache has the result
			}
	    	*/
    ...
    public static void sockStat(DatagramSocket sock) throws Exception {
		System.out.println( "Local addr: " + sock.getLocalAddress() 
			    + ":" + sock.getLocalPort());
		
		System.out.println( "Buffer size: snd = " + sock.getSendBufferSize() 
			    + "; rcv = " + sock.getReceiveBufferSize());		
